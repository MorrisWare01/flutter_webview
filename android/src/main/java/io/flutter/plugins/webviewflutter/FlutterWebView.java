...
public class FlutterWebView implements PlatformView, MethodCallHandler {
    ...
    private final WebViewBinding webViewBinding;

    public static void registerOnWebViewCreateCallback(OnWebViewCallback callback) {
        onWebViewCallback = callback;
    }
    ...
    FlutterWebView(
        ...
        webViewBinding = new WebViewBinding(context, messenger);
        // 监听WebView创建
        final OnWebViewCallback onWebViewCallback = FlutterWebView.onWebViewCallback;
        if (onWebViewCallback != null) {
            onWebViewCallback.onWebViewCreate(webViewBinding);
        }
    ...
    public void dispose() {
        final OnWebViewCallback onWebViewCallback = FlutterWebView.onWebViewCallback;
        if (webViewBinding != null && onWebViewCallback != null) {
            onWebViewCallback.onWebViewDispose(webViewBinding);
        }
    ...
    public interface OnWebViewCallback {
        void onWebViewCreate(WebViewBinding binding);

        void onWebViewDispose(WebViewBinding binding);
    }
    ...
    public class WebViewBinding {
        ...
        public WebViewBinding(Context context, BinaryMessenger messenger) {
